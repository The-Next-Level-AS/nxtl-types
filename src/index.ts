...
export interface SetMatrixRequest
    extends BaseProjectRequest, OptionalUserRequest {
    path: string;
...
export type CrudUserJourneyGetResult =
    | { status: 200; body: UserJourneyResponse | null }
    | { status: 401; body: UnauthorizedResponse }
    | { status: 500; body: ServerErrorResponse };
...
export type CrudRevisionResult =
    | { status: 200; body: RevisionResponse }
    | { status: 400; body: ErrorResponse }
    | { status: 401; body: UnauthorizedResponse }
    | { status: 404; body: ErrorResponse }
    | { status: 500; body: ServerErrorResponse };
...
export const NXTL_ENDPOINTS = {
    ...
    crudEntry: { method: "GET", path: "/crud/entry", auth: "apiKey" },
...
export interface NxtlApiContracts {
    ...
    transformation: EndpointContract<
    ...
    crudDeleteEntry: EndpointContract<
        DeleteEntryRequest,
        CrudDeleteEntryResult
    >;
    crudDeleteMatrix: EndpointContract<
        DeleteMatrixRequest,
        CrudDeleteMatrixResult
    >;
    ...
    >;
    crudSetArtifact: EndpointContract<
        SetArtifactRequest,
        CrudSetArtifactResult
    >;
    ...
    >;
    crudSyncEntries: EndpointContract<
        SyncEntriesRequest,
        CrudSyncEntriesResult
    >;
    ...
    crudCredentials: EndpointContract<
        CredentialsRequest,
        CrudCredentialsResult
    >;
